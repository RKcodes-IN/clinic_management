                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('items.update', $item->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="item_type" id="item_type" class="form-control" required>
                                @foreach (\App\Models\Item::getItemTypes() as $key => $type)
                                    <option value="{{ $key }}" {{ old('item_type', $item->item_type) == $key ? 'selected' : '' }}>
                                        {{ $type }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="uom_type" id="uom_type" class="form-control" required>
                                @foreach ($uomTypes as $uom)
                                    <option value="{{ $uom->id }}" {{ old('uom_type', $item->uom_type) == $uom->id ? 'selected' : '' }}>
                                        {{ $uom->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="brand" id="brand" class="form-control" required>
                                @foreach ($brands as $brand)
                                    <option value="{{ $brand->id }}" {{ old('brand', $item->brand) == $brand->id ? 'selected' : '' }}>
                                        {{ $brand->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="source_company" id="source_company" class="form-control" required>
                                @foreach ($companies as $company)
                                    <option value="{{ $company->id }}" {{ old('source_company', $item->source_company) == $company->id ? 'selected' : '' }}>
                                        {{ $company->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="ideal_quantity" id="ideal_quantity" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="reorder_quantity" id="reorder_quantity" class="form-control"
                        ...
                        <div class="form-group">
                            <label for="max_discount_percentage">Max Discount Percentage</label>
                            <input type="number" name="max_discount_percentage" id="max_discount_percentage" class="form-control"
                                value="{{ old('max_discount_percentage', $item->max_discount_percentage) }}" min="0" max="100">
