        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                            <form id="exportForm" method="POST" action="{{ route('stock.filte.exportexcel') }}">
                                @csrf
                        ...
                        <div class="col-6">
                            <form action="{{ route('stock.filte.exportpdf') }}" method="POST">
                                @csrf
                                <input type="hidden" name="item" value="{{ json_encode(request('item', [])) }}">
                                <input type="hidden" name="from_date" value="{{ request('from_date', '') }}">
                                <input type="hidden" name="to_date" value="{{ request('to_date', '') }}">
                ...
                <div class="form-container">
                    <div class="card-body">
                        <div class="form-container">
                            <form action="{{ route('stock.filte.filter') }}" method="POST" class="form-inline">
                                @csrf
                                <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td>{{ $transaction->getTotalStock($transaction->id) }}</td>
