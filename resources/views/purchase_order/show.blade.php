                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="border-0 bg-none"
                                    onclick="showMarkReceiveModal({{ $item->id }}, {{ $item->quantity }}, {{ $item->price }})">
...
<script>
    function showMarkReceiveModal(itemId, maxQuantity, initialUnitPrice) {
        Swal.fire({
            title: 'Mark Receive',
            html: `
            ...
            preConfirm: () => {
                ...
                rows.forEach((row) => {
                    ...
                    if (!receivedQuantity || receivedQuantity <= 0 || receivedQuantity > maxQuantity) {
                        isValid = false;
