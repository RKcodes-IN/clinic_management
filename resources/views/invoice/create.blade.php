                                ...
                                <table class="table table-bordered" id="pharmacy-items-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" name="pharmacy[0][description]" class="form-control">
                                            </td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="lab-tests-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <select name="labtests[0][item_id]" class="form-control labtest-item-select"
                                                    required>
                                            ...
                                            <td><input type="number" step="0.01" name="labtests[0][total]"
                                                    class="form-control" readonly></td>
                                            <td><input type="text" name="labtests[0][description]" class="form-control">
                                            </td>
                                            <td><button type="button" class="btn btn-danger remove-row">Remove</button>
                                            </td>
                                        </tr>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" name="invoice_time" value="{{ date('H:i') }}"
                                        id="invoice_time" class="form-control" required>
                                </div>
                                <div class="form-group">
