                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('stock.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="item_code_name" id="item_code_name" class="form-control"
                                            value="{{ old('item_code_name') }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="purchase_invoice_date" id="purchase_invoice_date"
                                            class="form-control" value="{{ old('purchase_invoice_date') }}" required>
                                    ...
                                    <div class="form-group">
                                        <label for="source_name">Source Company</label>
                                        <select name="source_name" id="source_name" class="form-control" required>
                                            @foreach ($sourceCompanies as $sourceCompany)
                                                <option value="{{ $sourceCompany->id }}"
                                                    {{ old('source_name') == $sourceCompany->id ? 'selected' : '' }}>
                                                    {{ $sourceCompany->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('source_name')
                                            <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="uom_type" id="uom_type" class="form-control" required>
                                            @foreach ($uomTypes as $uomType)
                                                <option value="{{ $uomType->id }}"
                                                    {{ old('uom_type') == $uomType->id ? 'selected' : '' }}>
                                                    {{ $uomType->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('uom_type')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="mrp" id="mrp" class="form-control"
                                            value="{{ old('mrp') }}" step="0.01" required>
                                        @error('mrp')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="discount_percentage" id="discount_percentage"
                                            class="form-control" value="{{ old('discount_percentage') }}" step="0.01"
                                            required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="discount_price" id="discount_price"
                                            class="form-control" value="{{ old('discount_price') }}" step="0.01"
                                            required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="additional_discount_percentage"
                                            id="additional_discount_percentage" class="form-control"
                                            value="{{ old('additional_discount_percentage') }}" step="0.01" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="additional_discount_price"
                                            id="additional_discount_price" class="form-control"
                                            value="{{ old('additional_discount_price') }}" step="0.01" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="gst_type" id="gst_type" class="form-control">
                                            @foreach ($gstTypes as $gstType)
                                                <option value="{{ $gstType->id }}"
                                                    {{ old('gst_type') == $gstType->id ? 'selected' : '' }}>
                                                    {{ $gstType->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('gst_type')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="gst_amount" id="gst_amount" class="form-control"
                                            value="{{ old('gst_amount') }}" step="0.01" required>
                                        @error('gst_amount')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cost_price" id="cost_price" class="form-control"
                                            value="{{ old('cost_price') }}" step="0.01" required>
                                        @error('cost_price')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <!-- Third Row (for Courier and Status) -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="courier_price_percentage">Courier Price Percentage</label>
                                        <input type="number" name="courier_price_percentage"
                                            id="courier_price_percentage" class="form-control"
                                            value="{{ old('courier_price_percentage') }}" step="0.01" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="courier_charge_amount" id="courier_charge_amount"
                                            class="form-control" value="{{ old('courier_charge_amount') }}"
                                            step="0.01" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="final_cost_price" id="final_cost_price"
                                            class="form-control" value="{{ old('final_cost_price') }}" step="0.01"
                                            required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="sale_discount" id="sale_discount"
                                            class="form-control" value="{{ old('sale_discount') }}" step="0.01"
                                            required>
                                        @error('sale_discount')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="profit_margin" id="profit_margin"
                                            class="form-control" value="{{ old('profit_margin') }}" step="0.01"
                                            required>
                                        @error('profit_margin')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="purchase_quantity" id="purchase_quantity"
                                            class="form-control" value="{{ old('purchase_quantity') }}" step="0.01"
                                            required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control" required>
                                            ...
                                            <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>
                                                Inactive</option>
                                            <option value="delete" {{ old('status') == 'delete' ? 'selected' : '' }}>
                                                Delete</option>
                                        </select>
                                        @error('status')
                                            <small class="text-danger">{{ $message }}</small>
