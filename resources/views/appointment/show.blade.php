            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush mt-4">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span>{{ \Carbon\Carbon::parse($appointment->time_from)->format('g:i A') }} -
                            {{ \Carbon\Carbon::parse($appointment->time_to)->format('g:i A') }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="card-footer text-center py-3">
                        <a href="{{ route('patient.show', ['id' => $appointment->patient->id]) }}"
                            class="btn btn-success btn-lg">Patient's Details</a>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card-footer text-center py-3">
