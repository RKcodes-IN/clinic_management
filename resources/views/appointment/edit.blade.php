                        ...
                        <form action="{{ route('appointments.update', $appointment->id) }}" method="POST">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="is_new_patient"
                                                ...
                                                {{ old('is_new_patient', $appointment->is_new_patient) === 'yes' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="new_patient_radio">Yes</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="is_new_patient"
                                                id="existing_patient_radio" value="no"
                                                {{ old('is_new_patient', $appointment->is_new_patient) === 'no' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="existing_patient_fields"
                                        style="{{ old('is_new_patient', $appointment->is_new_patient) === 'yes' ? 'display:none;' : '' }}">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" class="form-control">{{ old('address', $appointment->address) }}</textarea>
                                        @error('address')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                ...
                                                value="1"
                                                {{ old('is_previous_report_available', $appointment->is_previous_report_available) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="main_complaint" id="main_complaint" class="form-control">{{ old('main_complaint', $appointment->main_complaint) }}</textarea>
